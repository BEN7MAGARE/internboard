        ...
        <div class="card p-2">
            <div class="card-header">
                <div class="d-flex justify-content-end gap-2">
                    <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#createStudentModal"
                        id="createStudentToggle"><i class="bi bi-plus"></i> Add new</a>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex gap-2">
                                        ...
                                        <a href="#" target="_blank" class="btn btn-primary btn-sm"
                                            ...
                                            id="editStudentToggle" data-id="{{ $item->id }}"><i
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mt-2">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="studentSponsored"
                                        name="sponsored">
