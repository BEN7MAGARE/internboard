...
@section('content')
    <main class="container py-4">
        <div class="card mb-4">
            ...
            <form action="{{ route('applications.hire') }}" method="post" id="applicantsHireForm">
                @csrf
                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-check form-switch d-flex justify-content-end">
                                                    <input class="form-check-input applicantHireToggle" type="checkbox"
                                                        role="switch" id="applicantHireToggle{{ $item->id }}"
                                                        value="{{ $item->id }}"
                                                        {{ $item->status == 'hired' ? 'checked' : '' }}>
                                                    <label class="form-check-label ms-2"
                                                        for="applicantHireToggle{{ $item->id }}">
                                                        <strong>{{ $item->status == 'hired' ? 'Hired' : 'Hire Candidate' }}</strong>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
...
@section('footer_scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.applicantHireToggle').change(function() {
