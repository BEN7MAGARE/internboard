                                ...
                                <tr>
                                    ...
                                    <td class="d-flex gap-2">
                                        <a href="#" target="_blank" class="btn btn-primary btn-sm"
                                            ...
                                            id="editCourseToggle" data-id="{{ $item->id }}"><i
                ...
                <form action="{{ route('courses.store') }}" id="courseCreateForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="student_id" id="courseId" value="">
                            ...
                            <div class="col-md-4 form-group mb-1">
                                ...
                                <div class="input-group">
                                    <input name="course_code" type="text" class="form-control form-control-sm"
                            ...
                            <div class="col-md-4 form-group mb-1">
                                <label for="fee">
                                    Fee</label>
                                <div class="input-group">
                                    <input name="fee" type="text" class="form-control form-control-sm"
